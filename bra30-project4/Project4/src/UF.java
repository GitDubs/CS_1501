...
public class UF {
    ...
    //--------------------------------------------------------------------------
    //allConnected: Determines if the graph is separated or not
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    //allConnectedIgnore: Determines if a graph is connected without two 
    //specified edges. (this method is used for if a graph fails when removing 
    //two edges)
    //--------------------------------------------------------------------------
    public boolean allConnectedIgnore(int v1, int v2){
        int val;
        
        if(0 != v1 && 0 != v2)          //Make sure that we don't check against a 
            val = parent[0];            //vertex that we are removing
        else if(1 != v1 && 1 != v2)
            val = parent[1];
        else 
            val = parent[2];
